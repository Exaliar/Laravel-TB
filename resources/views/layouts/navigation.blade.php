<nav x-data="{ open: false }" class="">
    ...
    <div class="max-w-full mx-auto px-4 border-b border-tb-second sm:px-6 lg:px-8 fixed top-0 left-0 right-0 bg-tb">
        <div class="flex w-11/12 mx-auto justify-between h-16">
            <div class="flex">
                ...
                <!-- Navigation Links -->
                <div class="hidden space-x-4 sm:-my-px sm:ml-6 md:flex">
