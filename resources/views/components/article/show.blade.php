@if (isset($article) && !empty($article))
    <section>
        <article class="mx-auto mb-4 h-auto overflow-auto text-tb-second">
            <div class="flex">
            ...
            <div class="grid w-40 grid-flow-row-dense grid-cols-4 grid-rows-2 gap-2">
                <a class="col-span-2" href="{{ route('article.index') }}">
                    <x-primary-button class="my-3">
                        Wróć
                    </x-primary-button>
                </a>
                <a class="col-span-2" href="{{ route('article.edit', $article->id) }}">
                    <x-buttons.edit class="my-3">
                        Edytuj
                    </x-buttons.edit>
                </a>
                <a class="col-span-2 flex" href="#">
